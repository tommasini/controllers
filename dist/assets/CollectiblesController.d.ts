...
export declare class CollectiblesController extends BaseController<CollectiblesConfig, CollectiblesState> {
     ...
     */
    constructor({ onPreferencesStateChange, onNetworkStateChange, getERC721AssetName, getERC721AssetSymbol, getERC721TokenURI, getERC721OwnerOf, getERC1155BalanceOf, getERC1155TokenURI, }: {
     ...
     */
    findCollectibleByAddressAndTokenId(address: string, tokenId: string): {
     ...
     */
    updateCollectible(collectible: Collectible, updates: Partial<Collectible>): void;
    /**
     ...
     */
    resetCollectibleTransactionStatusByTransactionId(transactionId: string): boolean;
}

...
class CollectiblesController extends BaseController_1.BaseController {
     ...
     */
    findCollectibleByAddressAndTokenId(address, tokenId) {
        var _a;
        const { allCollectibles } = this.state;
        const { chainId, selectedAddress } = this.config;
        const collectibles = ((_a = allCollectibles[selectedAddress]) === null || _a === void 0 ? void 0 : _a[chainId]) || [];
     ...
     */
    updateCollectible(collectible, updates) {
        var _a;
        const { allCollectibles } = this.state;
        const { chainId, selectedAddress } = this.config;
        const collectibles = ((_a = allCollectibles[selectedAddress]) === null || _a === void 0 ? void 0 : _a[chainId]) || [];
        const collectibleInfo = this.findCollectibleByAddressAndTokenId(collectible.address, collectible.tokenId);
        if (!collectibleInfo) {
            return;
        }
     ...
     */
    resetCollectibleTransactionStatusByTransactionId(transactionId) {
        var _a;
        const { allCollectibles } = this.state;
        const { chainId, selectedAddress } = this.config;
        const collectibles = ((_a = allCollectibles[selectedAddress]) === null || _a === void 0 ? void 0 : _a[chainId]) || [];
